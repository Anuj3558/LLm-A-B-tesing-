  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="genzeon-card apple-blur p-8 animate-scale-in">
          {/* Logo and Header */}
          ...
          <div className="mb-6 p-4 bg-lilly-white rounded-lg">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full text-left p-2 text-xs bg-white rounded border hover:bg-vibrant-blue hover:text-white transition-colors"
              >
